...
UUID = "f8e78732-4cb7-4beb-9e63-7b7e01c41ced"                     # UUID，留空则自动生成
PORT = "39831"                   # Vmess端口，留空或0则自动生成
DOMAIN = "ounter.wellcloud.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMWNiNWVkNjZiNzkzZTk1YWYyZDAzM2U1OTdlOGE4M2UiLCJ0IjoiYTIzZjIzOGUtOTNhOC00ZDE0LTlkZGMtMTVjYzhiNzJlZjYwIiwicyI6Ik1XSm1NVFkxT1RjdFpEUmpaUzAwTmpRekxXRm1aVFl0T1dZNE9UQTVZVFE0WVdRNCJ9"# =========================================
# 添加命令行参数解析
def parse_args():
